...
skill_rules = [
                    'add_free_point','add_circle','add_free_circle',"circle_with_radius",'C_add_free_point', 'C_add_circle', 'C_add_free_circle', 'C_circle_with_radius', 'add_free_point_with_line', 'C_add_free_point_with_line', 'add_line', 
                    'C_add_line']+['width1', 'width2', 'width3']*5
